  ...
  <div class="container">
    ...
    <div class="container1" v-else-if="juegoAhorcado === 3">
      ...
      <div class="categorias">
        <div class="card">
    <div class="card-image"><img class="card-image" src="https://img.freepik.com/vector-premium/conjunto-animales-lindos-kawaii-ninos-que-aprenden-vocabulario-estilo-dibujos-animados-plana_34141-498.jpg?w=2000" alt=""> </div>
    <div class="category"> ANIMALES </div>
      <button class="btn3" @click="seleccionarCategoria('ANIMALES')">PLAY</button>
    </div>
    <div class="card">
    <div class="card-image"><img class="card-image" src="https://i0.wp.com/unprogramador.com/wp-content/uploads/2017/05/descubre-los-mejores-paises-para-vivir.jpg" alt=""></div>
    <div class="category"> PAISES</div>
    <button class="btn3" @click="seleccionarCategoria('PAISES')">PLAY</button>
    </div>
    <div class="card">
    <div class="card-image"><img class="card-image" src="https://s3.abcstatics.com/media/sociedad/2022/05/17/nombres-espana-apellidos--620x349.png" alt=""></div>
    <div class="category">NOMBRES</div>
    <button class="btn3" @click="seleccionarCategoria('NOMBRES')">PLAY</button>
    </div>
    <div class="card">
    <div class="card-image"><img class="card-image" src="https://dpplus.es/wp-content/uploads/2017/04/simbologia-del-color.jpg" alt=""></div>
    <div class="category">COLORES</div>
    <button class="btn3" @click="seleccionarCategoria('COLORES')">PLAY</button>
    </div>
    <div class="card">
    <div class="card-image"><img class="card-image" src="https://www.barcelona.cat/fabraicoats/centredart/sites/default/files/styles/slideshow/public/icons%201.jpg?itok=4Pkw6h3u" alt=""></div>
    <div class="category">COSAS</div>
    <button class="btn3" @click="seleccionarCategoria('COSAS')">PLAY</button>
    </div>
      </div>
